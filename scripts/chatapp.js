...
/* ***********************************************************
Stockage en la base de donnees locale a chaque utilisateur
**********************************************************************
*/ 
 ...
 */
function activate_chat_window(peer) {
    document.getElementsByClassName('chatPanel')[0].removeAttribute('style');
...
function UpdateChatMessages(txtmessage, client) {
    var peer = document.getElementById('divChatName_peername');
    var peername = peer.innerHTML ;
    var messageDisplay = '';
    ...
    if (client == true) {
        ...
        document.getElementById('messages').innerHTML += messageDisplay;
        Store(txtmessage,me,peername)

    }
    document.getElementById('messages').scrollTo(0, document.getElementById('messages').scrollHeight);
}
/* Restore old messages */
function getChatMessages(txtmessage, client) {
    ...
    if (map2.size > 1) {
        ...
        for (let [key, value] of map2) {
            if (username != key) { 
                ...
                document.getElementById('lstChat').innerHTML += "<li class='list-group-item list-group-item-action' onclick='call_user(\"" + key + "\")' id='speakerchat'>" +
                    "<div class='row'>" +
                    "<div class='col-md-6'>" +
